import infoImg01 from "../images/coba.jpg";
import infoImg02 from "../images/coba.jpg";
import infoImg03 from "../images/kay2.jpg";
import infoImg04 from "../images/coba.jpg";
import infoImg05 from "../images/kay2.jpg";
import infoImg06 from "../images/alfamidi.jpg";
import infoImg07 from "../images/sosial.jpg";
import infoImg08 from "../images/infomedia1.jpg";
import infoImg09 from "../images/lady2.jpg";
import infoImg10 from "../images/seven.jpeg";
import infoImg11 from "../images/shop.jpg";
...
const info = [
  ...
  },
  {
    ...
    city: "Yogyakarta",
    type: "Physically disabled",
    desc: "Lady On Point Indonesia (LOP.ID) is an MSME business engaged in women's clothing convection which was established in 2023. Lady On Point Indonesia (LOP.ID) has the slogan Wear Better, Be On Point Each Day!. Which means using the clothes we produce will make every woman's appearance even more perfect with their own version of beauty. We are optimistic that we can produce the highest quality innovative products at affordable prices, because all women have the right to appear On Point",
    reviews: [
      {
        name: "jhon doe",
      },
  ...
  },
  {
    ...
    city: "Yogyakarta",
    type: "Physically disabled",
    desc: "Purnama Jaya Service is located in Yogyakarta City. The company works in industries such as computer repair and household goods",
    reviews: [
      {
        name: "jhon doe",
      },
  ...
  },
  {
    ...
    city: "Yogyakarta",
    type: "Physically disabled",
    desc: "SEVEN INC is a holding company in Yogyakarta engaged in the creative industry and manages the fashion brands Crowsdenim, Alphawear, Indonesia Banget, Grenade, and several other well-known brands.",
    reviews: [
      {
        name: "jhon doe",
      },
